...
/**
 * ImageViewerGUI provides the GUI for the project. It displays the image
...
public class ImageViewerGUI
{
    ...
    public ImageViewerGUI(ImageViewer viewer)
    {
        ...
        fixedSize = false;
        makeFrame();
        int imagesViewed = viewer.getNumberOfImagesViewed();
        int avgWidth = viewer.averageImageWidth();
        statistics = new Popup();
    }
    ...
    /**
     * part of the challenge task
     * updates statistics on pop-up
     * displays the statistics pop-up
     */
    private void statisticsButton()
    {
        int imagesViewed = viewer.getNumberOfImagesViewed();
        int avgWidth = viewer.averageImageWidth();
        statistics.displayPopup(imagesViewed, avgWidth);
    }
